public class DirectionCommandMovieAdd : DirectionCommandBase
{
	...
	public DirectionCommandMovieAdd(Production p, int playID, int oldID, bool kill, bool loop, bool add, bool trim, int priority)
		: base(0)
	{
		prod = p;
		m_PlayID = playID;

public class DirectionCommandAnimeAddWithLayer : DirectionCommandBase
{
	...
	public DirectionCommandAnimeAddWithLayer(ProductionAnime p, int playID, int ptnID, int oldID, float layer, bool kill, bool loop, bool add, bool trim, int priority)
		: base(0)
	{
		prodAnime = p;
		m_PlayID = playID;
		...
		m_Trim = trim;
		m_Add = add;
		m_Class = CLASS.ADDANIMEWITHLAYER;
		m_Priority = priority;
	}

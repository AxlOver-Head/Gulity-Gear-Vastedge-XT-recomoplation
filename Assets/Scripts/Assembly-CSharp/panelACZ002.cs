...
public class panelACZ002
{
	...
	public const float DEF_POSZ_BASE = 0.02f;

	public const float DEF_POSZ_4TH = 0.02f;

	public const float DEF_POSZ_3RD = 0.02f;

	public const float DEF_POSZ_2ND = 0.02f;

	public const float DEF_POSZ_1ST = 0.02f;

	public const float DEF_POSZ_ADD11 = 0.02f;

	public const float DEF_POSZ_ADD12 = 0.02f;

	public const float DEF_POSZ_ADD21 = 0.02f;

	public const float DEF_POSZ_ADD22 = 0.02f;

	public const float DEF_POSZ_NUM3 = 0.02f;

	public const float DEF_POSZ_NUM2 = 0.02f;

	public const float DEF_POSZ_NUM1 = 0.02f;
	...
	private STATE[] m_state = new STATE[12];

	private int[] m_frame = new int[12];

	private bool[] m_active = new bool[12];
	...
	{
		int num = 0;
		parts_base = GameObject.Find("GUIDirection/Camera/Anchor/Panel_ACZ002/002");
		parts_4th = GameObject.Find("GUIDirection/Camera/Anchor/Panel_ACZ002/005");
		parts_3rd = GameObject.Find("GUIDirection/Camera/Anchor/Panel_ACZ002/006");
		parts_2nd = GameObject.Find("GUIDirection/Camera/Anchor/Panel_ACZ002/007");
		parts_1st = GameObject.Find("GUIDirection/Camera/Anchor/Panel_ACZ002/008");
		parts_add11 = GameObject.Find("GUIDirection/Camera/Anchor/Panel_ACZ002/012");
		parts_add12 = GameObject.Find("GUIDirection/Camera/Anchor/Panel_ACZ002/013");
		parts_add21 = GameObject.Find("GUIDirection/Camera/Anchor/Panel_ACZ002/014");
		parts_add22 = GameObject.Find("GUIDirection/Camera/Anchor/Panel_ACZ002/015");
		parts_num3 = GameObject.Find("GUIDirection/Camera/Anchor/Panel_ACZ002/018");
		parts_num2 = GameObject.Find("GUIDirection/Camera/Anchor/Panel_ACZ002/019");
		parts_num1 = GameObject.Find("GUIDirection/Camera/Anchor/Panel_ACZ002/020");
		...
		setPositionZ(0, 0.02f);
		setPositionZ(1, 0.02f);
		setPositionZ(2, 0.02f);
		setPositionZ(3, 0.02f);
		setPositionZ(4, 0.02f);
		setPositionZ(5, 0.02f);
		setPositionZ(6, 0.02f);
	...
	public void Update()
	{
		...
		for (num = 0; num < 12; num++)
		{
			...
			case STATE._END:
				...
				setPositionY(11, getDefPosY(11) - (float)m_frame[num] * 3f);
	...
	public float getDefPosX(int _kind)
	{
		...
		{
			128f, 37.12f, 37.12f, 37.12f, 37.12f, 37.12f, 37.12f, 128f, 128f, 235.2f,
			241.28f, 247.36f
		};
		return array[_kind];
	}
	...
	public float getDefPosY(int _kind)
	{
		float[] array = new float[12]
		{
			-132.48f, -132.48f, -132.48f, -132.48f, -132.48f, -132.48f, -132.48f, -132.48f, -132.48f, -129.92f,
			-129.92f, -129.92f
		};
		return array[_kind];
	}

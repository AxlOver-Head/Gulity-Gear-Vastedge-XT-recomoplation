...
public class panelBE2001b
{
	...
	public const float DEF_POSY_TOTAL_NUM4 = -117.44f;

	public const float DEF_POSY_TOTAL_NUM3 = -117.44f;

	public const float DEF_POSY_TOTAL_NUM2 = -117.44f;

	public const float DEF_POSY_TOTAL_NUM1 = -117.44f;

	public const float DEF_POSY_GET_NUM4 = -95.04f;

	public const float DEF_POSY_GET_NUM3 = -95.04f;

	public const float DEF_POSY_GET_NUM2 = -95.04f;

	public const float DEF_POSY_GET_NUM1 = -95.04f;
	...
	{
		int num = 0;
		parts_total_num4 = GameObject.Find("GUIDirection/Camera/Anchor/Panel_BE2001/010");
		parts_total_num3 = GameObject.Find("GUIDirection/Camera/Anchor/Panel_BE2001/011");
		parts_total_num2 = GameObject.Find("GUIDirection/Camera/Anchor/Panel_BE2001/012");
		parts_total_num1 = GameObject.Find("GUIDirection/Camera/Anchor/Panel_BE2001/013");
		parts_get_num4 = GameObject.Find("GUIDirection/Camera/Anchor/Panel_BE2001/016");
		parts_get_num3 = GameObject.Find("GUIDirection/Camera/Anchor/Panel_BE2001/017");
		parts_get_num2 = GameObject.Find("GUIDirection/Camera/Anchor/Panel_BE2001/018");
		parts_get_num1 = GameObject.Find("GUIDirection/Camera/Anchor/Panel_BE2001/019");
	...
	{
		float[] array = new float[8] { -117.44f, -117.44f, -117.44f, -117.44f, -95.04f, -95.04f, -95.04f, -95.04f };
		return array[_kind];
	}

...
public class UISimMenuKisyu : MonoBehaviour
{
	...
	private void Start()
	{
		base.gameObject.name = "SimMenu_Kisyu";
		m_Move = 0f;
		m_CurrentPage = 0;
		m_ClickButtonID = -1;
		m_IsClick = false;
		...
		m_IsDrag = false;
		m_IsFlick = false;
		m_Bx_Back = GameObject.Find("SimMenu_Kisyu/Camera/Anchor2/Panel/Button_Back").GetComponent<BoxCollider>();
		m_Bx_ArrL = GameObject.Find("SimMenu_Kisyu/Camera/Anchor3/Panel/Arrow_L").GetComponent<BoxCollider>();
		m_Bx_ArrR = GameObject.Find("SimMenu_Kisyu/Camera/Anchor3/Panel/Arrow_R").GetComponent<BoxCollider>();
		m_Title1 = GameObject.Find("SimMenu_Kisyu/Camera/Anchor2/Panel/Title1").GetComponent<UISprite>();
		m_Title2 = GameObject.Find("SimMenu_Kisyu/Camera/Anchor2/Panel/Title2").GetComponent<UISprite>();
		m_Title3 = GameObject.Find("SimMenu_Kisyu/Camera/Anchor2/Panel/Title3").GetComponent<UISprite>();
		m_Title4 = GameObject.Find("SimMenu_Kisyu/Camera/Anchor2/Panel/Title4").GetComponent<UISprite>();
		m_Sp_Page1 = GameObject.Find("SimMenu_Kisyu/Camera/Anchor3/Panel/Page_1").GetComponent<UISprite>();
		m_Sp_Page2 = GameObject.Find("SimMenu_Kisyu/Camera/Anchor3/Panel/Page_2").GetComponent<UISprite>();
		m_Sp_Page3 = GameObject.Find("SimMenu_Kisyu/Camera/Anchor3/Panel/Page_3").GetComponent<UISprite>();
		m_Sp_Page4 = GameObject.Find("SimMenu_Kisyu/Camera/Anchor3/Panel/Page_4").GetComponent<UISprite>();
		m_Panel1 = GameObject.Find("SimMenu_Kisyu/Camera/Anchor1/Panel/Panel_Kisyu");
		m_Panel2 = GameObject.Find("SimMenu_Kisyu/Camera/Anchor1/Panel/Panel_Haitou");
		m_Panel3 = GameObject.Find("SimMenu_Kisyu/Camera/Anchor1/Panel/Panel_Chance");
		m_Panel4 = GameObject.Find("SimMenu_Kisyu/Camera/Anchor1/Panel/Panel_Kitaido");
		setPage(0);
		setInput(false);
	}

...
public class UISimDataRireki
{
	...
	public UISimDataRireki(int _id, UISimData _parent)
	{
		string empty = string.Empty;
		string[] name = new string[5] { "num_0_001", "num_0_010", "num_0_100", "num_1_000", "num_0X000" };
		empty = ((_id + 1 < 10) ? (_parent.name + "/Camera/Anchor1_Top/Panel_3_Rireki/ScrollPanel/Rireki/Rireki_0" + (_id + 1) + "/") : (_parent.name + "/Camera/Anchor1_Top/Panel_3_Rireki/ScrollPanel/Rireki/Rireki_" + (_id + 1) + "/"));

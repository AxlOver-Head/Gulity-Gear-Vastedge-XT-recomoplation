...
public class UIDialog_08 : UIDialog_Common
{
	...
	private void Awake()
	{
		string text = "Dialog_08(Clone)/Camera/Anchor/Panel/";
		...
		init();
		m_Panel = GameObject.Find("Dialog_08(Clone)/Camera/Anchor/Panel");
		...
		m_Btn2 = GameObject.Find(text + "Button2").GetComponent<UIButtonMessage>();
		m_Btn2.target = base.gameObject;
		m_Btn2.functionName = "OnClickButton2";
		m_Btn3 = GameObject.Find(text + "Button3").GetComponent<UIButtonMessage>();

...
public class UIDataSlump
{
	...
	public UIDataSlump(UIData _parent)
	{
		string text = "Data(Clone)/Camera/Anchor2_Center/Panel_4_Slump/";
	...
	public void setData(SlumpData slump)
	{
		m_Slump = slump;

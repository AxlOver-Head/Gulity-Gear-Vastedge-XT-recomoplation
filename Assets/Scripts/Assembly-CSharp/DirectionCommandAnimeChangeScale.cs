public class DirectionCommandAnimeChangeScale : DirectionCommandBase
{
	...
	public DirectionCommandAnimeChangeScale(ProductionAnime p, float layer, float sx, float sy, float dx, float dy, int frame, int exe)
		: base(exe)
	{
		prodAnime = p;
		m_Layer = layer;

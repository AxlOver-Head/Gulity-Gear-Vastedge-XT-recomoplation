public class UISimDataData
{
	...
	public UISimDataData(UISimData _parent)
	{
		string text = _parent.name + "/Camera/Anchor2_Center/Panel_1_Data/";
		...
		string[] name4 = new string[8] { "Data_04/num_00001", "Data_04/num_00010", "Data_04/num_00100", "Data_04/num_01000", "Data_04/num_10000", "Data_04/num_100000", "Data_04/num_comma", "Data_04/num_minus" };
		string[] name5 = new string[7] { "Data_05/num_00001", "Data_05/num_00010", "Data_05/num_00100", "Data_05/num_01000", "Data_05/num_10000", "Data_05/num_100000", "Data_05/num_comma" };
		string[] name6 = new string[7] { "Data_06/num_00001", "Data_06/num_00010", "Data_06/num_00100", "Data_06/num_01000", "Data_06/num_10000", "Data_06/num_100000", "Data_06/num_comma" };
		string[] name7 = new string[8] { "Data_07/num_00001", "Data_07/num_00010", "Data_07/num_00100", "Data_07/num_01000", "Data_07/num_10000", "Data_07/num_100000", "Data_07/num_comma", "Data_07/num_minus" };
	...
	public void setData(int data_01, int data_02, int data_03, int data_04, int data_05, int data_06, int data_07, int data_08, int data_09, int data_10)
	{
		...
		parent.setSpriteMinus(num, array[7], 5);
		array = m_Data_Num_05;
		num = data_05;
		parent.setSpriteNum(0, num, array[0], false);
		parent.setSpriteNum(1, num, array[1], true);

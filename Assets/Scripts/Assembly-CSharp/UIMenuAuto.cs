...
public class UIMenuAuto : MonoBehaviour
{
	...
	private GameObject[] m_ObjAutoPlay = new GameObject[5];
	...
	{
		m_SelAutoPlay = PlayUserData.saveData.m_autoSettei;
		m_SelEyeStop = PlayUserData.saveData.m_autoLevel;
	}

	private void Start()
	{
		base.gameObject.name = "Menu_Auto";
		m_ClickButtonID = -1;
		m_IsClick = false;
		m_ObjEyeStop[0] = GameObject.Find("Menu_Auto/Camera/Anchor1/Panel2/Panel_Auto/Button_1");
		m_ObjEyeStop[1] = GameObject.Find("Menu_Auto/Camera/Anchor1/Panel2/Panel_Auto/Button_2");
		m_ObjAutoPlay[0] = GameObject.Find("Menu_Auto/Camera/Anchor1/Panel2/Panel_Meoshi/Button_1");
		m_ObjAutoPlay[1] = GameObject.Find("Menu_Auto/Camera/Anchor1/Panel2/Panel_Meoshi/Button_2");
		m_ObjAutoPlay[2] = GameObject.Find("Menu_Auto/Camera/Anchor1/Panel2/Panel_Meoshi/Button_3");
		m_ObjAutoPlay[3] = GameObject.Find("Menu_Auto/Camera/Anchor1/Panel2/Panel_Meoshi/Button_4");
		m_ObjAutoPlay[4] = GameObject.Find("Menu_Auto/Camera/Anchor1/Panel2/Panel_Meoshi/Button_5");
		m_Bx_Back = GameObject.Find("Menu_Auto/Camera/Anchor2/Panel/Button_Back").GetComponent<BoxCollider>();
		m_Bx_Help = GameObject.Find("Menu_Auto/Camera/Anchor2/Panel/Button_Help").GetComponent<BoxCollider>();
		m_Bx_Start = GameObject.Find("Menu_Auto/Camera/Anchor1/Panel2/Button_Start").GetComponent<BoxCollider>();
	...
	private void Update()
	{
		...
		case 2:
			...
			{
				m_Dialog_11 = SGLG.createDialog(11).GetComponent<UIDialog_11>();
				m_ClickButtonID = 5;
				break;
			}
		...
		case 3:
			...
			m_SelAutoPlay = (m_SelAutoPlay + 1) % 5;
	...
	{
		PlayUserData.saveData.m_autoLevel = (byte)m_SelEyeStop;
		PlayUserData.saveData.setAuto((byte)m_SelAutoPlay);
		PlayUserData.save();
	}
}

...
public class UIMenuSousa : MonoBehaviour
{
	...
	private void Start()
	{
		base.gameObject.name = "Menu_Sousa";
		m_ClickButtonID = -1;
		m_IsClick = false;
		m_Bx_Back = GameObject.Find("Menu_Sousa/Camera/Anchor2/Panel/Button_Back").GetComponent<BoxCollider>();
		m_Bx_ArrL = GameObject.Find("Menu_Sousa/Camera/Anchor3/Panel/Arrow_L").GetComponent<BoxCollider>();
		m_Bx_ArrR = GameObject.Find("Menu_Sousa/Camera/Anchor3/Panel/Arrow_R").GetComponent<BoxCollider>();
		for (int i = 0; i < m_Sp_Page.Length; i++)
		{
			int num = i + 1;
			m_Sp_Page[i] = GameObject.Find("Menu_Sousa/Camera/Anchor3/Panel/Page_" + num).GetComponent<UISprite>();
			m_Panels[i] = GameObject.Find("Menu_Sousa/Camera/Anchor1/Panel/Panel_Sousa" + num);
			m_Title[i] = GameObject.Find("Menu_Sousa/Camera/Anchor2/Panel/Title" + num).GetComponent<UISprite>();
		}
		setPage(0);
		setInput(false);
	}

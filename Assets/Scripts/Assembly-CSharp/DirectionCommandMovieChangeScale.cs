public class DirectionCommandMovieChangeScale : DirectionCommandBase
{
	...
	public DirectionCommandMovieChangeScale(Production p, float layer, float sx, float sy, float dx, float dy, int frame, int exe)
		: base(exe)
	{
		prod = p;
		m_Layer = layer;

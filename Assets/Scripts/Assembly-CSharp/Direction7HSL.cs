public class Direction7HSL : DirectionBase
{
	private int m_cnt;

	public Direction7HSL(DirectionManager _mng, byte _high, byte _low, byte _mode, DirectionManager.DIR _dir)
	...
	public override void start()
	{
		...
		if (low == 0)
		{
			...
			case 1:
				...
				evt.eventAddMovie(DirectionManager.MOVIE.hsl1001_sly1, DirectionManager.MOVIE.hsl1001_sol1, true, false, false, false);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl1001_sol2, false, false, false, true, 70, 72, 101, 111);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl1001_sly2, false, false, false, true, 186, 72, 102, 111);
			...
			case 2:
				...
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl1001_sly2, false, false, false, true, 186, 72, 102, 141);
			...
			case 3:
				...
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl2001_sly, true, false, false, true, 206, 94, 80, 0);
				break;
			case 4:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl2004_sly, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2004_sly_loop, DirectionManager.MOVIE.hsl2004_sly, false, true, false, false);
			...
			case 5:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl2005_sly, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2005_sly_loop, DirectionManager.MOVIE.hsl2005_sly, false, true, false, false);
			...
			case 6:
				...
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5007_sly1, DirectionManager.MOVIE.hsl2007_sol_hai1, false, false, false, false);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S1398, Sound.CH.VC1, true, 1f, 44);
				evt.eventPlaySound(DirectionManager.SOUND.S0610, Sound.CH.SE0, true, 1f, 56);
				evt.eventPlaySound(DirectionManager.SOUND.S0611, Sound.CH.SE1, true, 1f, 83);
				evt.eventPlaySound(DirectionManager.SOUND.S0612, Sound.CH.SE0, true, 1f, 114);
				evt.eventPlaySound(DirectionManager.SOUND.S1382, Sound.CH.VC0, true, 1f, 142);
				DirectionYakuManager._MAIN_GIMMICK_PTTERNS_219();
				break;
			case 7:
				evt.eventDisableBefore(mng, 0);
			...
			case 8:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl2007_sol_hai1, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2007_sly, DirectionManager.MOVIE.hsl2007_sol_hai1, false, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5010_hai1, DirectionManager.MOVIE.hsl2007_sly, false, false, false, false);
				evt.eventFadeSound(Sound.CH.BGM, 1f, 0f, 10, 144);
				evt.eventPlaySound(DirectionManager.SOUND.S0135, Sound.CH.BGM, true, 1f, 247);
				evt.eventPlaySound(DirectionManager.SOUND.S0476, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S0910, Sound.CH.VC0, true, 1f, 20);
				evt.eventPlaySound(DirectionManager.SOUND.S0496, Sound.CH.SE1, true, 1f, 44);
				evt.eventPlaySound(DirectionManager.SOUND.S1396, Sound.CH.VC0, true, 1f, 50);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0946, Sound.CH.VC0, true, 1f, 193);
				evt.eventPlaySound(DirectionManager.SOUND.S0220, Sound.CH.SE0, true, 1f, 247);
				...
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5010_sly, false, false, false, false, 0, 0, 80, 60);
			...
			case 9:
				...
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2008_sly, DirectionManager.MOVIE.hsl2008_sol, false, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5007_sly1, DirectionManager.MOVIE.hsl2008_sly, false, false, false, false);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S1384, Sound.CH.VC1, true, 1f, 145);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0611, Sound.CH.SE1, true, 1f, 189);
				evt.eventPlaySound(DirectionManager.SOUND.S0612, Sound.CH.SE0, true, 1f, 220);
				evt.eventPlaySound(DirectionManager.SOUND.S1382, Sound.CH.VC0, true, 1f, 250);
				DirectionYakuManager._MAIN_GIMMICK_PTTERNS_227();
				break;
			case 10:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl2008_sol, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2008_sly, DirectionManager.MOVIE.hsl2008_sol, false, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5010_hai1, DirectionManager.MOVIE.hsl2008_sly, false, false, false, false);
				evt.eventFadeSound(Sound.CH.BGM, 1f, 0f, 10, 144);
				evt.eventPlaySound(DirectionManager.SOUND.S0135, Sound.CH.BGM, true, 1f, 353);
				evt.eventPlaySound(DirectionManager.SOUND.S0243, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S0222, Sound.CH.SE1, true, 1f, 45);
				evt.eventPlaySound(DirectionManager.SOUND.S0864, Sound.CH.VC0, true, 1f, 59);
				evt.eventPlaySound(DirectionManager.SOUND.S0369, Sound.CH.SE0, true, 1f, 133);
				evt.eventPlaySound(DirectionManager.SOUND.S0496, Sound.CH.SE1, true, 1f, 149);
				evt.eventPlaySound(DirectionManager.SOUND.S1396, Sound.CH.VC1, true, 1f, 155);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0946, Sound.CH.VC0, true, 1f, 299);
				evt.eventPlaySound(DirectionManager.SOUND.S0220, Sound.CH.SE0, true, 1f, 353);
				...
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5010_sly, false, false, false, false, 0, 0, 80, 146);
			...
			case 11:
				...
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5007_sly1, DirectionManager.MOVIE.hsl2011_sol1, false, false, false, false);
				evt.eventPlaySound(DirectionManager.SOUND.S0243, Sound.CH.SE0, true, 1f, 0);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S1384, Sound.CH.VC1, true, 1f, 84);
				evt.eventPlaySound(DirectionManager.SOUND.S0265, Sound.CH.SE0, true, 1f, 88);
				evt.eventPlaySound(DirectionManager.SOUND.S0610, Sound.CH.SE1, true, 1f, 102);
				evt.eventPlaySound(DirectionManager.SOUND.S0611, Sound.CH.SE0, true, 1f, 129);
				evt.eventPlaySound(DirectionManager.SOUND.S0612, Sound.CH.SE1, true, 1f, 160);
				evt.eventPlaySound(DirectionManager.SOUND.S1382, Sound.CH.VC0, true, 1f, 190);
				break;
			case 12:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl2011_sol1, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2011_sly, DirectionManager.MOVIE.hsl2011_sol1, false, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5010_hai1, DirectionManager.MOVIE.hsl2011_sly, false, false, false, false);
				evt.eventFadeSound(Sound.CH.BGM, 1f, 0f, 10, 144);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S1396, Sound.CH.VC1, true, 1f, 115);
				evt.eventPlaySound(DirectionManager.SOUND.S0491, Sound.CH.SE0, true, 1f, 136);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0946, Sound.CH.VC0, true, 1f, 264);
				...
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5010_sly, false, false, false, false, 0, 0, 80, 109);
			...
			case 13:
				...
				evt.eventPlaySound(DirectionManager.SOUND.S1396, Sound.CH.VC1, true, 1f, 187);
				evt.eventPlaySound(DirectionManager.SOUND.S0491, Sound.CH.SE0, true, 1f, 208);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0946, Sound.CH.VC0, true, 1f, 336);
				evt.eventPlaySound(DirectionManager.SOUND.S0220, Sound.CH.SE1, true, 1f, 390);
				...
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5010_sly, false, false, false, false, 0, 0, 80, 179);
			...
			case 14:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl2012_sly, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2012_sly_loop, DirectionManager.MOVIE.hsl2012_sly, false, true, false, false);
			...
			case 15:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl2013_sly, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5009_sly1, DirectionManager.MOVIE.hsl2013_sly, false, false, false, false);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0612, Sound.CH.SE0, true, 1f, 141);
				evt.eventPlaySound(DirectionManager.SOUND.S1382, Sound.CH.VC1, true, 1f, 169);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5009_sol, true, false, false, true, 100, 72, 79, 71);
				break;
			case 16:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl2013_sly, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5013_hai1, DirectionManager.MOVIE.hsl2013_sly, false, false, false, false);
				evt.eventFadeSound(Sound.CH.BGM, 1f, 0f, 10, 144);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0946, Sound.CH.VC1, true, 1f, 218);
				evt.eventPlaySound(DirectionManager.SOUND.S0220, Sound.CH.SE1, true, 1f, 272);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5013_sol, false, false, false, true, 100, 72, 89, 61);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5013_sly, false, false, false, false, 0, 0, 90, 61);
			...
			case 17:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl2015_sly, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5009_sly1, DirectionManager.MOVIE.hsl2015_sly, false, false, false, false);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0612, Sound.CH.SE0, true, 1f, 180);
				evt.eventPlaySound(DirectionManager.SOUND.S1382, Sound.CH.VC0, true, 1f, 208);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5009_sol, true, false, false, true, 100, 72, 79, 110);
				break;
			case 18:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl2015_sly, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5013_hai1, DirectionManager.MOVIE.hsl2015_sly, false, false, false, false);
				evt.eventFadeSound(Sound.CH.BGM, 1f, 0f, 10, 144);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0497, Sound.CH.SE0, true, 1f, 210);
				evt.eventPlaySound(DirectionManager.SOUND.S0946, Sound.CH.VC0, true, 1f, 253);
				evt.eventPlaySound(DirectionManager.SOUND.S0220, Sound.CH.SE1, true, 1f, 307);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5013_sol, false, false, false, true, 100, 72, 89, 100);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5013_sly, false, false, false, false, 0, 0, 90, 100);
			...
			case 19:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.yjd005, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2015_sly, DirectionManager.MOVIE.yjd005, false, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5013_hai1, DirectionManager.MOVIE.hsl2015_sly, false, false, false, false);
				evt.eventFadeSound(Sound.CH.BGM, 1f, 0f, 10, 144);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0496, Sound.CH.SE0, true, 1f, 214);
				evt.eventPlaySound(DirectionManager.SOUND.S0497, Sound.CH.SE1, true, 1f, 281);
				evt.eventPlaySound(DirectionManager.SOUND.S0946, Sound.CH.VC0, true, 1f, 324);
				evt.eventPlaySound(DirectionManager.SOUND.S0220, Sound.CH.SE0, true, 1f, 378);
				evt.eventPlaySound(DirectionManager.SOUND.S0073, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5013_sol, false, false, false, true, 100, 72, 89, 171);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5013_sly, false, false, false, false, 0, 0, 90, 171);
			...
			case 20:
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0611, Sound.CH.SE1, true, 1f, 129);
				evt.eventPlaySound(DirectionManager.SOUND.S0612, Sound.CH.SE0, true, 1f, 160);
				evt.eventPlaySound(DirectionManager.SOUND.S1382, Sound.CH.VC0, true, 1f, 190);
				break;
			case 21:
				evt.eventDisableBefore(mng, 0);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0219, Sound.CH.SE1, false, 1f, 159);
				evt.eventPlaySound(DirectionManager.SOUND.S0497, Sound.CH.SE0, true, 1f, 232);
				evt.eventPlaySound(DirectionManager.SOUND.S0946, Sound.CH.VC0, true, 1f, 275);
				evt.eventPlaySound(DirectionManager.SOUND.S0220, Sound.CH.SE1, true, 1f, 329);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5010_sol, false, false, false, true, 60, 84, 90, 109);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5010_add, false, false, true, false, 0, 0, 85, 109);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5010_sly, false, false, false, false, 0, 0, 80, 109);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5010_add2, false, false, true, false, 0, 0, 75, 109);
			...
			case 22:
				...
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2020_sly, DirectionManager.MOVIE.hsl2020_sol, false, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5009_sly1, DirectionManager.MOVIE.hsl2020_sly, false, false, false, false);
				evt.eventPlaySound(DirectionManager.SOUND.S0243, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S0479, Sound.CH.SE1, true, 1f, 45);
				evt.eventPlaySound(DirectionManager.SOUND.S1043, Sound.CH.VC0, true, 1f, 56);
				evt.eventPlaySound(DirectionManager.SOUND.S0369, Sound.CH.SE0, true, 1f, 72);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0612, Sound.CH.SE1, true, 1f, 244);
				evt.eventPlaySound(DirectionManager.SOUND.S1382, Sound.CH.VC1, true, 1f, 274);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5009_sol, true, false, false, true, 100, 72, 79, 171);
				break;
			case 23:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl2011_sol3, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2020_sol, DirectionManager.MOVIE.hsl2011_sol3, false, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2020_sly, DirectionManager.MOVIE.hsl2020_sol, false, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5013_hai1, DirectionManager.MOVIE.hsl2020_sly, false, false, false, false);
				evt.eventFadeSound(Sound.CH.BGM, 1f, 0f, 10, 144);
				evt.eventPlaySound(DirectionManager.SOUND.S0135, Sound.CH.BGM, true, 1f, 375);
				evt.eventPlaySound(DirectionManager.SOUND.S0243, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S0479, Sound.CH.SE1, true, 1f, 45);
				evt.eventPlaySound(DirectionManager.SOUND.S1043, Sound.CH.VC0, true, 1f, 56);
				evt.eventPlaySound(DirectionManager.SOUND.S0369, Sound.CH.SE0, true, 1f, 72);
				evt.eventPlaySound(DirectionManager.SOUND.S0483, Sound.CH.SE1, true, 1f, 72);
				evt.eventPlaySound(DirectionManager.SOUND.S0907, Sound.CH.VC1, true, 1f, 110);
				evt.eventPlaySound(DirectionManager.SOUND.S0914, Sound.CH.VC0, true, 1f, 136);
				evt.eventPlaySound(DirectionManager.SOUND.S0496, Sound.CH.SE0, true, 1f, 206);
				evt.eventPlaySound(DirectionManager.SOUND.S0497, Sound.CH.SE1, true, 1f, 274);
				evt.eventPlaySound(DirectionManager.SOUND.S0946, Sound.CH.VC1, true, 1f, 317);
				evt.eventPlaySound(DirectionManager.SOUND.S0220, Sound.CH.SE0, true, 1f, 371);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5013_sol, false, false, false, true, 100, 72, 89, 161);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5013_sly, false, false, false, false, 0, 0, 90, 161);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5003_hai1, false, false, false, false, 0, 0, 80, 246);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5003_sol, false, false, false, false, 0, 0, 75, 246);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5003_sol_loop, DirectionManager.MOVIE.hsl5003_sol, false, true, false, false);
				break;
			case 24:
				evt.eventDisableBefore(mng, 0);
				...
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5013_hai1, DirectionManager.MOVIE.hsl2020_sly, false, false, false, false);
				evt.eventFadeSound(Sound.CH.BGM, 1f, 0f, 10, 144);
				evt.eventPlaySound(DirectionManager.SOUND.S0135, Sound.CH.BGM, true, 1f, 447);
				evt.eventPlaySound(DirectionManager.SOUND.S0243, Sound.CH.SE0, true, 1f, 72);
				evt.eventPlaySound(DirectionManager.SOUND.S0479, Sound.CH.SE1, true, 1f, 117);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0497, Sound.CH.SE1, true, 1f, 346);
				evt.eventPlaySound(DirectionManager.SOUND.S0946, Sound.CH.VC1, true, 1f, 389);
				evt.eventPlaySound(DirectionManager.SOUND.S0220, Sound.CH.SE0, true, 1f, 443);
				evt.eventPlaySound(DirectionManager.SOUND.S0073, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5013_sol, false, false, false, true, 100, 72, 89, 232);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5013_sly, false, false, false, false, 0, 0, 90, 232);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5003_hai1, false, false, false, false, 0, 0, 80, 317);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5003_sol, false, false, false, false, 0, 0, 75, 317);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5003_sol_loop, DirectionManager.MOVIE.hsl5003_sol, false, true, false, false);
				break;
			case 25:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl2022_sly, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2022_sly_loop, DirectionManager.MOVIE.hsl2022_sly, false, true, false, false);
			...
			case 26:
				...
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2023_sly, DirectionManager.MOVIE.hsl2023_sol, false, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5007_sly1, DirectionManager.MOVIE.hsl2023_sly, false, false, false, false);
				evt.eventPlaySound(DirectionManager.SOUND.S0243, Sound.CH.SE0, true, 1f, 0);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S1384, Sound.CH.VC1, true, 1f, 141);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0611, Sound.CH.SE0, true, 1f, 185);
				evt.eventPlaySound(DirectionManager.SOUND.S0612, Sound.CH.SE1, true, 1f, 216);
				evt.eventPlaySound(DirectionManager.SOUND.S1382, Sound.CH.VC0, true, 1f, 246);
				DirectionYakuManager._MAIN_GIMMICK_PTTERNS_278();
				break;
			case 27:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl2023_sol, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2023_sly, DirectionManager.MOVIE.hsl2023_sol, false, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5010_hai1, DirectionManager.MOVIE.hsl2023_sly, false, false, false, false);
				evt.eventFadeSound(Sound.CH.BGM, 1f, 0f, 10, 144);
				evt.eventPlaySound(DirectionManager.SOUND.S0135, Sound.CH.BGM, true, 1f, 350);
				evt.eventPlaySound(DirectionManager.SOUND.S0243, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S0485, Sound.CH.SE1, true, 1f, 30);
				evt.eventPlaySound(DirectionManager.SOUND.S0887, Sound.CH.VC0, true, 1f, 32);
				evt.eventPlaySound(DirectionManager.SOUND.S0496, Sound.CH.SE0, true, 1f, 145);
				evt.eventPlaySound(DirectionManager.SOUND.S1396, Sound.CH.VC1, true, 1f, 151);
				evt.eventPlaySound(DirectionManager.SOUND.S0219, Sound.CH.SE1, true, 1f, 180);
				evt.eventPlaySound(DirectionManager.SOUND.S0497, Sound.CH.SE0, true, 1f, 253);
				evt.eventPlaySound(DirectionManager.SOUND.S0946, Sound.CH.VC0, true, 1f, 296);
				...
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5010_sly, false, false, false, false, 0, 0, 80, 144);
			...
			case 28:
				...
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5010_hai1, DirectionManager.MOVIE.hsl2023_sly, false, false, false, false);
				evt.eventFadeSound(Sound.CH.BGM, 1f, 0f, 10, 144);
				evt.eventPlaySound(DirectionManager.SOUND.S0135, Sound.CH.BGM, true, 1f, 422);
				evt.eventPlaySound(DirectionManager.SOUND.S0243, Sound.CH.SE0, true, 1f, 72);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0496, Sound.CH.SE0, true, 1f, 217);
				evt.eventPlaySound(DirectionManager.SOUND.S1396, Sound.CH.VC1, true, 1f, 223);
				evt.eventPlaySound(DirectionManager.SOUND.S0219, Sound.CH.SE1, true, 1f, 252);
				evt.eventPlaySound(DirectionManager.SOUND.S0497, Sound.CH.SE0, true, 1f, 325);
				evt.eventPlaySound(DirectionManager.SOUND.S0946, Sound.CH.VC0, true, 1f, 368);
				...
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5010_sly, false, false, false, false, 0, 0, 80, 215);
			...
			case 29:
				...
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2026_sly, DirectionManager.MOVIE.hsl2026_sol, false, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5010_hai1, DirectionManager.MOVIE.hsl2026_sly, false, false, false, false);
				evt.eventFadeSound(Sound.CH.BGM, 1f, 0f, 10, 144);
				evt.eventPlaySound(DirectionManager.SOUND.S0135, Sound.CH.BGM, true, 1f, 326);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S1396, Sound.CH.VC1, true, 1f, 123);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0945, Sound.CH.VC0, true, 1f, 272);
				evt.eventPlaySound(DirectionManager.SOUND.S0220, Sound.CH.SE0, true, 1f, 326);
				...
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5010_sly, false, false, false, false, 0, 0, 80, 135);
			...
			case 30:
				...
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5010_hai1, DirectionManager.MOVIE.hsl2026_sly, false, false, false, false);
				evt.eventFadeSound(Sound.CH.BGM, 1f, 0f, 10, 144);
				evt.eventPlaySound(DirectionManager.SOUND.S0135, Sound.CH.BGM, true, 1f, 398);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S1396, Sound.CH.VC1, true, 1f, 195);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0945, Sound.CH.VC0, true, 1f, 344);
				evt.eventPlaySound(DirectionManager.SOUND.S0220, Sound.CH.SE0, true, 1f, 398);
				evt.eventPlaySound(DirectionManager.SOUND.S0073, Sound.CH.SE0, true, 1f, 0);
				...
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5010_sly, false, false, false, false, 0, 0, 80, 206);
			...
			case 32:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl2002_sly1, false, true, false, false, 0, 0, 100, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.push, false, false, false, true, 128, 119, 90, 6);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0223, Sound.CH.SE0, true, 1f, 6);
				break;
			case 33:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl2002_sly2, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2002_sol2, DirectionManager.MOVIE.hsl2002_sly2, false, false, false, false);
			...
			case 34:
				...
				evt.eventPlaySound(DirectionManager.SOUND.S1386, Sound.CH.SE1, true, 1f, 18);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl3001_sol, true, false, false, true, 70, 72, 90, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl3001_sly, false, false, false, true, 156, 72, 80, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl3001_sly_loop, DirectionManager.MOVIE.hsl3001_sly, false, true, false, true);
			...
			case 35:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl3004_sly, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl3004_sly_loop, DirectionManager.MOVIE.hsl3004_sly, false, true, false, false);
				evt.eventPlaySound(DirectionManager.SOUND.S0488, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S1387, Sound.CH.VC0, true, 1f, 0);
				break;
			case 36:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl3005_sly, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl3005_sly_loop, DirectionManager.MOVIE.hsl3005_sly, false, true, false, false);
				evt.eventPlaySound(DirectionManager.SOUND.S0489, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S1388, Sound.CH.VC0, true, 1f, 0);
				break;
			case 37:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl3006_sly, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5002_hai1, DirectionManager.MOVIE.hsl3006_sly, false, false, false, false);
				evt.eventPlaySound(DirectionManager.SOUND.S0498, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S1389, Sound.CH.VC0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S0266, Sound.CH.SE1, true, 1f, 46);
				evt.eventPlaySound(DirectionManager.SOUND.S0491, Sound.CH.SE0, true, 1f, 52);
				evt.eventPlaySound(DirectionManager.SOUND.S0492, Sound.CH.SE1, true, 1f, 80);
				evt.eventPlaySound(DirectionManager.SOUND.S0935, Sound.CH.VC0, true, 1f, 93);
				break;
			case 38:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl3006_sly, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5004_hai1, DirectionManager.MOVIE.hsl3006_sly, false, false, false, false);
				evt.eventFadeSound(Sound.CH.BGM, 1f, 0f, 10, 46);
				evt.eventPlaySound(DirectionManager.SOUND.S0200, Sound.CH.BGM, true, 1f, 143);
				evt.eventPlaySound(DirectionManager.SOUND.S0498, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S1389, Sound.CH.VC0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S0940, Sound.CH.VC1, true, 1f, 46);
				evt.eventPlaySound(DirectionManager.SOUND.S0219, Sound.CH.SE1, true, 1f, 52);
				evt.eventPlaySound(DirectionManager.SOUND.S0941, Sound.CH.VC0, true, 1f, 90);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5004_sol, false, false, false, false, 0, 0, 85, 45);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5004_sly, false, false, false, true, 216, 94, 90, 45);
				break;
			case 39:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl3018_sly1, false, false, false, false, 0, 0, 100, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S0498, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S1389, Sound.CH.VC0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S0490, Sound.CH.SE1, true, 1f, 34);
				evt.eventPlaySound(DirectionManager.SOUND.S0931, Sound.CH.VC1, true, 1f, 68);
				break;
			case 40:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl3008_sly, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5002_hai1, DirectionManager.MOVIE.hsl3008_sly, false, false, false, false);
				evt.eventPlaySound(DirectionManager.SOUND.S0243, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S0499, Sound.CH.SE1, true, 1f, 45);
				evt.eventPlaySound(DirectionManager.SOUND.S1391, Sound.CH.VC0, true, 1f, 60);
				evt.eventPlaySound(DirectionManager.SOUND.S0266, Sound.CH.SE0, true, 1f, 125);
				evt.eventPlaySound(DirectionManager.SOUND.S0939, Sound.CH.VC1, true, 1f, 125);
				evt.eventPlaySound(DirectionManager.SOUND.S0492, Sound.CH.SE1, true, 1f, 156);
				evt.eventPlaySound(DirectionManager.SOUND.S1038, Sound.CH.VC0, true, 1f, 169);
				break;
			case 41:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl3008_sly, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5004_hai1, DirectionManager.MOVIE.hsl3008_sly, false, false, false, false);
				...
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5004_sol, false, false, false, false, 0, 0, 85, 120);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5005_sly, false, false, false, true, 216, 94, 90, 120);
				break;
			case 42:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl3014_sly, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl3014_sly_loop, DirectionManager.MOVIE.hsl3014_sly, false, true, false, false);
			...
			case 43:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl3011_sly1, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl3011_sly1_loop, DirectionManager.MOVIE.hsl3011_sly1, false, true, false, false);
				evt.eventPlaySound(DirectionManager.SOUND.S0500, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S1392, Sound.CH.VC0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S1393, Sound.CH.VC1, true, 1f, 66);
				evt.eventPlaySound(DirectionManager.SOUND.S0269, Sound.CH.SE1, true, 1f, 76);
				break;
			case 44:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl3011_sly2, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5002_hai1, DirectionManager.MOVIE.hsl3011_sly2, false, false, false, false);
				evt.eventPlaySound(DirectionManager.SOUND.S0501, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S1040, Sound.CH.VC0, true, 1f, 39);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S1037, Sound.CH.VC1, true, 1f, 124);
				break;
			case 45:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl3011_sly2, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5004_hai1, DirectionManager.MOVIE.hsl3011_sly2, false, false, false, false);
				evt.eventFadeSound(Sound.CH.BGM, 1f, 0f, 10, 90);
				evt.eventPlaySound(DirectionManager.SOUND.S0200, Sound.CH.BGM, true, 1f, 187);
				evt.eventPlaySound(DirectionManager.SOUND.S0501, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S1040, Sound.CH.VC0, true, 1f, 39);
				evt.eventPlaySound(DirectionManager.SOUND.S0940, Sound.CH.VC1, true, 1f, 90);
				...
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5004_sol, false, false, false, false, 0, 0, 85, 89);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5006_sly, false, false, false, true, 206, 72, 90, 89);
				break;
			case 46:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl3003_sly, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl3003_sly_loop, DirectionManager.MOVIE.hsl3003_sly, false, true, false, false);
				evt.eventPlaySound(DirectionManager.SOUND.S0264, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S1397, Sound.CH.SE1, true, 1f, 23);
				evt.eventPlayMovie(DirectionManager.MOVIE.push_hit, true, false, false, true, 128, 119, 90, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.push_hit_add, true, false, true, false, 0, 0, 80, 0);
				break;
			case 47:
				...
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2012_sly, DirectionManager.MOVIE.hsl4001_sol, false, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2012_sly_loop, DirectionManager.MOVIE.hsl2012_sly, false, true, false, false);
			...
			case 48:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl4001_sol, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2022_sly, DirectionManager.MOVIE.hsl4001_sol, false, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2022_sly_loop, DirectionManager.MOVIE.hsl2022_sly, false, true, false, false);
				evt.eventPlaySound(DirectionManager.SOUND.S0493, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S0942, Sound.CH.VC0, true, 1f, 18);
			...
			case 53:
				...
				evt.eventPlaySound(DirectionManager.SOUND.S1398, Sound.CH.VC0, true, 1f, 65);
				evt.eventPlaySound(DirectionManager.SOUND.S0610, Sound.CH.SE1, true, 1f, 77);
				evt.eventPlaySound(DirectionManager.SOUND.S0611, Sound.CH.SE0, true, 1f, 104);
				evt.eventPlaySound(DirectionManager.SOUND.S0612, Sound.CH.SE1, true, 1f, 135);
				evt.eventPlaySound(DirectionManager.SOUND.S1382, Sound.CH.VC1, true, 1f, 163);
				DirectionYakuManager._MAIN_GIMMICK_PTTERNS_219();
				break;
			case 54:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl4001_sol, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2007_sol_hai1, DirectionManager.MOVIE.hsl4001_sol, false, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2007_sly, DirectionManager.MOVIE.hsl2007_sol_hai1, true, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5010_hai1, DirectionManager.MOVIE.hsl2007_sly, false, false, false, false);
				evt.eventFadeSound(Sound.CH.BGM, 1f, 0f, 10, 144);
				evt.eventPlaySound(DirectionManager.SOUND.S0135, Sound.CH.BGM, true, 1f, 287);
				evt.eventPlaySound(DirectionManager.SOUND.S0493, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S0942, Sound.CH.VC0, true, 1f, 18);
				evt.eventPlaySound(DirectionManager.SOUND.S0476, Sound.CH.SE1, true, 1f, 40);
				evt.eventPlaySound(DirectionManager.SOUND.S0910, Sound.CH.VC1, true, 1f, 60);
				evt.eventPlaySound(DirectionManager.SOUND.S0496, Sound.CH.SE0, true, 1f, 84);
				evt.eventPlaySound(DirectionManager.SOUND.S1396, Sound.CH.VC0, true, 1f, 90);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0946, Sound.CH.VC1, true, 1f, 233);
				evt.eventPlaySound(DirectionManager.SOUND.S0220, Sound.CH.SE1, true, 1f, 287);
				...
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5010_sly, false, false, false, false, 0, 0, 80, 91);
			...
			case 55:
				...
				evt.eventPlaySound(DirectionManager.SOUND.S1384, Sound.CH.VC0, true, 1f, 185);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0611, Sound.CH.SE0, true, 1f, 229);
				evt.eventPlaySound(DirectionManager.SOUND.S0612, Sound.CH.SE1, true, 1f, 260);
				evt.eventPlaySound(DirectionManager.SOUND.S1382, Sound.CH.VC1, true, 1f, 290);
				DirectionYakuManager._MAIN_GIMMICK_PTTERNS_227();
				break;
			case 56:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl4001_sol, false, false, false, false, 0, 0, 100, 0);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2008_sol, DirectionManager.MOVIE.hsl4001_sol, false, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2008_sly, DirectionManager.MOVIE.hsl2008_sol, true, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5010_hai1, DirectionManager.MOVIE.hsl2008_sly, false, false, false, false);
				evt.eventFadeSound(Sound.CH.BGM, 1f, 0f, 10, 144);
				evt.eventPlaySound(DirectionManager.SOUND.S0135, Sound.CH.BGM, true, 1f, 393);
				evt.eventPlaySound(DirectionManager.SOUND.S0493, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S0942, Sound.CH.VC0, true, 1f, 18);
				evt.eventPlaySound(DirectionManager.SOUND.S0243, Sound.CH.SE0, true, 1f, 40);
				evt.eventPlaySound(DirectionManager.SOUND.S0222, Sound.CH.SE1, true, 1f, 85);
				evt.eventPlaySound(DirectionManager.SOUND.S0864, Sound.CH.VC0, true, 1f, 99);
				evt.eventPlaySound(DirectionManager.SOUND.S0369, Sound.CH.SE0, true, 1f, 173);
				evt.eventPlaySound(DirectionManager.SOUND.S0496, Sound.CH.SE1, true, 1f, 189);
				evt.eventPlaySound(DirectionManager.SOUND.S1396, Sound.CH.VC1, true, 1f, 195);
				evt.eventPlaySound(DirectionManager.SOUND.S0219, Sound.CH.SE0, true, 1f, 223);
				evt.eventPlaySound(DirectionManager.SOUND.S0497, Sound.CH.SE1, true, 1f, 294);
				evt.eventPlaySound(DirectionManager.SOUND.S0946, Sound.CH.VC0, true, 1f, 339);
				evt.eventPlaySound(DirectionManager.SOUND.S0220, Sound.CH.SE0, true, 1f, 393);
				...
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5010_sly, false, false, false, false, 0, 0, 80, 177);
			...
			case 57:
				...
				evt.eventAddMovie(DirectionManager.MOVIE.hsl2011_sly, DirectionManager.MOVIE.hsl2011_sol1, false, false, false, false);
				evt.eventAddMovie(DirectionManager.MOVIE.hsl5007_sly1, DirectionManager.MOVIE.hsl2011_sly, false, false, false, false);
				evt.eventPlaySound(DirectionManager.SOUND.S0493, Sound.CH.SE0, true, 1f, 0);
				evt.eventPlaySound(DirectionManager.SOUND.S0942, Sound.CH.VC0, true, 1f, 18);
				evt.eventPlaySound(DirectionManager.SOUND.S0243, Sound.CH.SE1, true, 1f, 40);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S1384, Sound.CH.VC0, true, 1f, 124);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0611, Sound.CH.SE0, true, 1f, 169);
				evt.eventPlaySound(DirectionManager.SOUND.S0612, Sound.CH.SE1, true, 1f, 200);
				evt.eventPlaySound(DirectionManager.SOUND.S1382, Sound.CH.VC1, true, 1f, 230);
				break;
			case 58:
				evt.eventDisableBefore(mng, 0);
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl4001_sol, false, false, false, false, 0, 0, 100, 0);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S1396, Sound.CH.VC0, true, 1f, 134);
				evt.eventPlaySound(DirectionManager.SOUND.S0491, Sound.CH.SE1, true, 1f, 155);
				...
				evt.eventPlaySound(DirectionManager.SOUND.S0946, Sound.CH.VC1, true, 1f, 283);
				evt.eventPlaySound(DirectionManager.SOUND.S0220, Sound.CH.SE0, true, 1f, 337);
				...
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl5010_sly, false, false, false, false, 0, 0, 80, 137);
			...
			case 59:
				...
				evt.eventPlayMovie(DirectionManager.MOVIE.hsl1001_sly2, false, false, false, true, 186, 72, 102, 162);
		...
		if (low == 0)
		{
			...
			case 1:
				...
				DirectionLedManager.m_panel_HOH_sl_vs_01(DirectionLedManager.changeLineNum(LEDPanelManager.LINE.LAYER_5M));
				break;
			case 2:
				...
				DirectionLedManager.m_panel_HOH_sl_vs_02(DirectionLedManager.changeLineNum(LEDPanelManager.LINE.LAYER_5M));
				break;
			case 3:
				DirectionLedManager.OFF_2(DirectionLedManager.changeLineNum(LEDMainManager.LINE.BGM_2));
			...
			case 35:
				DirectionLedManager.OFF_2(DirectionLedManager.changeLineNum(LEDMainManager.LINE.BGM_2));
				DirectionLedManager.GD_HSL_enm_P(DirectionLedManager.changeLineNum(LEDMainManager.LINE.GD));
				break;
			case 36:
				DirectionLedManager.OFF_2(DirectionLedManager.changeLineNum(LEDMainManager.LINE.BGM_2));
				DirectionLedManager.GD_HSL_enm_K(DirectionLedManager.changeLineNum(LEDMainManager.LINE.GD));
				break;
			case 37:
				DirectionLedManager.OFF_2(DirectionLedManager.changeLineNum(LEDMainManager.LINE.BGM_2));
				DirectionLedManager.GD_HSL_enm_HS(DirectionLedManager.changeLineNum(LEDMainManager.LINE.GD));
				break;
			case 38:
				DirectionLedManager.OFF_2(DirectionLedManager.changeLineNum(LEDMainManager.LINE.BGM_2));
			...
			case 40:
				DirectionLedManager.OFF_2(DirectionLedManager.changeLineNum(LEDMainManager.LINE.BGM_2));
				DirectionLedManager.GD_HSL_enm_MP(DirectionLedManager.changeLineNum(LEDMainManager.LINE.GD));
				break;
			case 41:
				DirectionLedManager.OFF_2(DirectionLedManager.changeLineNum(LEDMainManager.LINE.BGM_2));
				DirectionLedManager.OFF_3(DirectionLedManager.changeLineNum(LEDMainManager.LINE.UNDERPANEL));
			...
			case 44:
				DirectionLedManager.OFF_2(DirectionLedManager.changeLineNum(LEDMainManager.LINE.BGM_2));
				DirectionLedManager.GD_HSL_enm_DT(DirectionLedManager.changeLineNum(LEDMainManager.LINE.GD));
				break;
			case 45:
				DirectionLedManager.OFF_2(DirectionLedManager.changeLineNum(LEDMainManager.LINE.BGM_2));
				DirectionLedManager.OFF_3(DirectionLedManager.changeLineNum(LEDMainManager.LINE.UNDERPANEL));
			...
			case 59:
				...
				DirectionLedManager.m_panel_HOH_sl_vs_03(DirectionLedManager.changeLineNum(LEDPanelManager.LINE.LAYER_5M));
				break;
			}
		}
		dirWinChr();
	...
	private void restartBGM()
	{
		...
		{
			evt.eventPlaySound(DirectionManager.SOUND.S0142, Sound.CH.BGM, false, 1f, 0);
		}
	}
